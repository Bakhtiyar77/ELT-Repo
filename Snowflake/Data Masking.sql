...
GRANT ROLE ANALYST_MASKED TO USER BAHTEE;
GRANT ROLE ANALYST_FULL TO USER BAHTEE;
...
-- apply policy
ALTER TABLE IF EXISTS CUSTOMERS MODIFY COLUMN full_name SET MASKING POLICY names;
